...
```{r, year by month plot, fig.width=11, fig.height=6.5}
# set colors 
...
```{r, year by month by residency, fig.width=11, fig.height=6.5}
# resident color  
res_c_2022 <- "#1b7837"
...
```{r, display combo plot, fig.width=11, fig.height=6, echo=FALSE}
combo_plot
```
